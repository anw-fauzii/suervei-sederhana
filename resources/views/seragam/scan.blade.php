		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST" action="{{ route('scan.store') }}">
					...
					{{$seragam->nama}} ({{$seragam->ukuran}}) <br> Tersedia {{$seragam->stok}} 
					</span>
                    <div class="wrap-input100 validate-input" data-validate = "NIS Harus Di isi">
                        <input class="input100" type="hidden" name="id" value="{{$seragam->id}}" placeholder="Username" readonly>
						<input class="input100" type="text" name="" value="{{$seragam->nama}} ({{$seragam->ukuran}})" placeholder="Username" readonly>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "">
						<input class="input100" type="text" name="" value="Rp. {{number_format($seragam->harga_jual)}}" placeholder="Username" readonly>
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-id-badge" aria-hidden="true"></i>
						</span>
